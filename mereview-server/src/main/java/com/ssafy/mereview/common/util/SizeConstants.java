...
public class SizeConstants {
    ...
    public static final Map<String, Integer> REVIEW_ACHIEVEMENT_MAX_COUNT_MAP = Map.of(
    ...
    public static final Map<String, Integer> COMMENT_ACHIEVEMENT_MAX_COUNT_MAP = Map.of(
